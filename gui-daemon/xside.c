...
static void handle_window_dump_body_grant_refs(Ghandles *g,
        struct windowdata *vm_window, size_t untrusted_wd_body_len,
        size_t *img_data_size, struct shm_args_hdr **shm_args,
        size_t *shm_args_len) {
    size_t refs_len;
...
static void handle_window_dump_body(Ghandles *g, struct windowdata *vm_window,
        uint32_t wd_type, size_t untrusted_wd_body_len, size_t *img_data_size,
        struct shm_args_hdr **shm_args, size_t *shm_args_len) {
    switch (wd_type) {
        case WINDOW_DUMP_TYPE_GRANT_REFS:
            handle_window_dump_body_grant_refs(g, vm_window,
                    untrusted_wd_body_len, img_data_size, shm_args,
                    shm_args_len);
            break;
        default:
            // not reachable
...
static void handle_window_dump(Ghandles *g, struct windowdata *vm_window,
    ...
    handle_window_dump_body(g, vm_window, wd_type, untrusted_wd_body_len,
